...
import org.policetracks.android.support.receiver.ReceiverProxy;
...
public class ServiceProxy extends Service {
    ...
    public static final String WAKELOCK_TAG_BROKER_PING = "org.policetracks.android.wakelock.broker.ping";
	...
	public static ProxyableService loadService(int id) {
		...
		Timber.v("subscribed to messagelocation:%s", App.getEventBus().hasSubscriberForEvent(org.policetracks.android.messages.MessageLocation.class));
	...
	protected static boolean checkPlayServices() {
		...
		return  org.policetracks.android.support.unfree.GoogleApiAvailability.checkPlayServicesWithOverride();
	}
}
