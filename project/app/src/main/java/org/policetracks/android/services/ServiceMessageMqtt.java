...
import org.policetracks.android.support.PausableThreadPoolExecutor;
...
public class ServiceMessageMqtt implements OutgoingMessageProcessor, RejectedExecutionHandler, StatefulServiceMessageEndpoint {
	...
	private static final String RECEIVER_ACTION_RECONNECT = "org.policetracks.android.RECEIVER_ACTION_RECONNECT";
    private static final String RECEIVER_ACTION_PING = "org.policetracks.android.RECEIVER_ACTION_PING";
	...
	private boolean connect() {
		...
		try {
			...
			lastConnectionOptions.setMqttVersion(Preferences.getMqttProtocolLevel());
